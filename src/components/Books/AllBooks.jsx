    ...
    <main className={styles.main}>
      <div className={styles.container}>
        <div className={styles.header}>
          <h1 className={styles.title}>Explore Our Book Categories</h1>
        ...
        <div className={styles.cardGrid}>
          ...
          <section className={styles.card}>
            <Link to="/books/computer-graphics" className={styles.card}>
          ...
          <section className={styles.card}>
            <Link to="/books/operating-systems" className={styles.card}>
...
//           <h1 className={styles.title}>Explore Our Book Categories</h1>
//           <p className={styles.description}>
//             Browse through our extensive collection of books across various technical domains.
//           </p>
//         </div>
